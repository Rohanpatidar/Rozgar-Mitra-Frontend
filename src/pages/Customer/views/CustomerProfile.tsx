        ...
        <Box sx={{ maxWidth: '800px', mx: 'auto' }}>
            ...
            <Paper sx={{ p: 4, borderRadius: '16px', boxShadow: '0 4px 15px rgba(0,0,0,0.05)' }}>
                ...
                <Box sx={{ display: 'grid', gridTemplateColumns: '1fr', gap: 3, maxWidth: '400px', mb: 3 }}>
                    <TextField label="Old Password" type="password" value={currentPassword} onChange={(event) => setCurrentPassword(event.target.value)} disabled={changingPassword} fullWidth />
                ...
                <Button variant="contained" onClick={() => void handlePasswordChange()} disabled={changingPassword} sx={{ backgroundColor: CUSTOMER_THEME.warning, '&:hover': { backgroundColor: '#d97706' } }}>
