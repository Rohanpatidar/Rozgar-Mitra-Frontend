...
export const CustomerServices: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const refreshActiveBookings = () => customerApi.getBookings().then(res => {
        ...
        void refreshActiveBookings();
        const interval = window.setInterval(() => { void refreshActiveBookings(); }, 10000);
